...
const ei_impulse_t impulse_550186_0 = {
    .project_id = 550186,
    .project_owner = "Particle",
    .project_name = "Running-Faucet-Detection",
    .impulse_id = 3,
...
ei_impulse_handle_t impulse_handle_550186_0 = ei_impulse_handle_t( &impulse_550186_0 );
ei_impulse_handle_t& ei_default_impulse = impulse_handle_550186_0;
